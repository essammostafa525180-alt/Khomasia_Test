using Application.CQRS.NotificationTemplate.Commands;
using Application.CQRS.NotificationTemplate.Queries;
...
namespace WebApi.Controllers
{
    ...
    public class NotificationTemplateController : ControllerBase
    {
        ...
        [EnableETag]
        [HttpGet("get-all")]
        public async Task<IActionResult> GetAll([FromQuery] GetAllNotificationTemplateQuery query)
        {
        ...
        [HttpPut("update/{id}")]
        public async Task<IActionResult> Update([FromRoute] int id, [FromBody] UpdateNotificationTemplateCommand command)
        {
            if (id != command.Id)
                return BadRequest();
            var result = await _mediator.Send(command);
