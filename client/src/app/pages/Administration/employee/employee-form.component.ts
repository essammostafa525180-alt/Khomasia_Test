...
export class EmployeeFormComponent implements OnInit {
  ...
  get title(): string {
    return this.mode === 'create' ? 'New Employee' : 'Edit Employee';
  }
  ...
  save(): void {
    ...
    this.saving = true;
    const value = this.form.getRawValue() as CreateEmployee;
    ...
    request$.subscribe({
      next: () => {
        ...
        this.notification.success(
          this.mode === 'create' ? 'Employee created.' : 'Employee updated.'
        );
        this.close(true);
      },
      error: () => {
  ...
  private close(saved: boolean): void {
    ...
    this.router.navigate(['/administration/employee']);
  }
}
