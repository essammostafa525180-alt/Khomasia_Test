...
@Component({
  selector: 'app-inventroy-item-request-withdraw-form',
  standalone: true,
  imports: [MATERIAL_IMPORTS],
  templateUrl: './inventroy-item-request-withdraw-form.component.html',
  styleUrl: './inventroy-item-request-withdraw-form.component.css',
})
export class InventroyItemRequestWithdrawEntityFormComponent implements OnInit {
  private readonly fb = inject(FormBuilder);
  private readonly service = inject(InventroyItemRequestWithdrawService);
  ...
  get title(): string {
    return this.mode === 'create' ? 'New Inventroy Item Request Withdraw' : 'Edit Inventroy Item Request Withdraw';
  }
    ...
    request$.subscribe({
      next: () => {
        ...
        this.notification.success(
          this.mode === 'create' ? 'Inventroy Item Request Withdraw created.' : 'Inventroy Item Request Withdraw updated.'
        );
        this.close(true);
      },
      error: () => {
  ...
  private close(saved: boolean): void {
    ...
    this.router.navigate(['/inventory/inventroy-item-request-withdraw']);
  }
}
