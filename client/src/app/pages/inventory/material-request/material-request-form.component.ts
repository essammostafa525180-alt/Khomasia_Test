...
@Component({
  ...
  styleUrl: './material-request-form.component.css',
})
export class InventroyItemRequestWithdrawFormComponent implements OnInit {
  private readonly fb = inject(FormBuilder);
  private readonly service = inject(MaterialRequestService);
  ...
  get title(): string {
    return this.mode === 'create' ? 'New Material Request' : 'Edit Material Request';
  }
    ...
    request$.subscribe({
      next: () => {
        ...
        this.notification.success(
          this.mode === 'create' ? 'Material Request created.' : 'Material Request updated.'
        );
        this.close(true);
      },
      error: () => {
