...
@Component({
  selector: 'app-asset-item-move-form',
  standalone: true,
  imports: [MATERIAL_IMPORTS],
  templateUrl: './asset-item-move-form.component.html',
  styleUrl: './asset-item-move-form.component.css',
})
export class AssetItemMoveEntityFormComponent implements OnInit {
  private readonly fb = inject(FormBuilder);
  private readonly service = inject(AssetItemMoveService);
  ...
  get title(): string {
    return this.mode === 'create' ? 'New Asset Item Move' : 'Edit Asset Item Move';
  }
    ...
    request$.subscribe({
      next: () => {
        ...
        this.notification.success(
          this.mode === 'create' ? 'Asset Item Move created.' : 'Asset Item Move updated.'
        );
        this.close(true);
      },
      error: () => {
  ...
  private close(saved: boolean): void {
    ...
    this.router.navigate(['/inventory/asset-item-move']);
  }
}
