...
@Component({
  selector: 'app-view-delivery-order',
  standalone: true,
  imports: [MATERIAL_IMPORTS],
  templateUrl: './delivery-order.component.html',
  styleUrl: './delivery-order.component.css',
})
export class ViewDeliveryOrderComponent implements AfterViewInit {
  ...
  onNew(): void {
    this.router.navigate(['/procurement/delivery-order/new']);
  }

  onEdit(row: any): void {
    this.router.navigate(['/procurement/delivery-order', row.id, 'edit']);
  }
