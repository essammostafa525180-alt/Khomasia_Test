...
@Component({
  selector: 'app-view-purchase-request-assign',
  standalone: true,
  imports: [MATERIAL_IMPORTS],
  templateUrl: './purchase-request-assign.component.html',
  styleUrl: './purchase-request-assign.component.css',
})
export class ViewPurchaseRequestAssignComponent implements AfterViewInit {
  ...
  onNew(): void {
    this.router.navigate(['/procurement/purchase-request-assign/new']);
  }

  onEdit(row: any): void {
    this.router.navigate(['/procurement/purchase-request-assign', row.id, 'edit']);
  }
