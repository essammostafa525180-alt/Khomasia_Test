...
@Component({
  selector: 'app-view-supplier-order-variance',
  standalone: true,
  imports: [MATERIAL_IMPORTS],
  templateUrl: './supplier-order-variance.component.html',
  styleUrl: './supplier-order-variance.component.css',
})
export class ViewSupplierOrderVarianceComponent implements AfterViewInit {
  ...
  onNew(): void {
    this.router.navigate(['/procurement/supplier-order-variance/new']);
  }

  onEdit(row: any): void {
    this.router.navigate(['/procurement/supplier-order-variance', row.id, 'edit']);
  }
