...
export class ViewPurchaseOrderComponent implements AfterViewInit {
  ...
  onNew(): void {
    this.router.navigate(['/procurement/purchase-order/new']);
  }

  onEdit(row: any): void {
    this.router.navigate(['/procurement/purchase-order', row.id, 'edit']);
  }
