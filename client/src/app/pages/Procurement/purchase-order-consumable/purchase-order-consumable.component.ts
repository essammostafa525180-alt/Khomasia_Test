...
@Component({
  selector: 'app-view-purchase-order-consumable',
  standalone: true,
  imports: [MATERIAL_IMPORTS],
  templateUrl: './purchase-order-consumable.component.html',
  styleUrl: './purchase-order-consumable.component.css',
})
export class ViewPurchaseOrderConsumableComponent implements AfterViewInit {
  ...
  onNew(): void {
    this.router.navigate(['/procurement/purchase-order-consumable/new']);
  }

  onEdit(row: any): void {
    this.router.navigate(['/procurement/purchase-order-consumable', row.id, 'edit']);
  }
