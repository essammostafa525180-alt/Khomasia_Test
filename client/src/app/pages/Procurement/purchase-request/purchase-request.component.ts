...
export class ViewPurchaseRequestComponent implements AfterViewInit {
  ...
  onNew(): void {
    this.router.navigate(['/procurement/purchase-request/new']);
  }

  onEdit(row: any): void {
    this.router.navigate(['/procurement/purchase-request', row.id, 'edit']);
  }
