...
export class ExpenseFormComponent implements OnInit {
  ...
  get title(): string {
    return this.mode === 'create' ? 'New Expense' : 'Edit Expense';
  }
  ...
  save(): void {
    ...
    this.saving = true;
    const value = this.form.getRawValue() as CreateExpense;
    ...
    request$.subscribe({
      next: () => {
        ...
        this.notification.success(
          this.mode === 'create' ? 'Expense created.' : 'Expense updated.'
        );
        this.close(true);
      },
      error: () => {
  ...
  private close(saved: boolean): void {
    ...
    this.router.navigate(['/other/expense']);
  }
}
