...
public class UpdateInventoryItemCommand : ICommand<Result>
{
...
internal class UpdateInventoryItemCommandHandler : ICommandHandler<UpdateInventoryItemCommand, Result>
{
