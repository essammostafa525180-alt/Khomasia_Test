...
public class CreateInventoryItemMerge20240522Command : ICommand<Result<int>>
{
...
internal class CreateInventoryItemMerge20240522CommandHandler : ICommandHandler<CreateInventoryItemMerge20240522Command, Result<int>>
{
    private readonly IApplicationDbContext _db;

    public CreateInventoryItemMerge20240522CommandHandler(IApplicationDbContext db)
    {
        _db = db;
    }

    public async Task<Result<int>> Handle(CreateInventoryItemMerge20240522Command request, CancellationToken cancellationToken)
    {
        var affected = await _db.Database.ExecuteSqlInterpolatedAsync(
            $"INSERT INTO [$InventoryItemMerge_2024-05-22] ([ItemNumber2024], [ItemNumber2023], [ItemNumber2024Id], [ItemNumber2023Id], [TotalQuantity2023], [OpeningQuantity2024], [TotalQuantity2024]) VALUES ({request.ItemNumber2024}, {request.ItemNumber2023}, {request.ItemNumber2024Id}, {request.ItemNumber2023Id}, {request.TotalQuantity2023}, {request.OpeningQuantity2024}, {request.TotalQuantity2024})");
