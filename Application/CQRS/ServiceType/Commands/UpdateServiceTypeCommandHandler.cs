...
public class UpdateServiceTypeCommand : ICommand<Result>
{
...
internal class UpdateServiceTypeCommandHandler : ICommandHandler<UpdateServiceTypeCommand, Result>
{
    ...
    public async Task<Result> Handle(UpdateServiceTypeCommand request, CancellationToken cancellationToken)
    {
        ...
        return result > 0 ? Result.Success() : Result.Failure(Errors.ServiceTypeNotUpdated);
    }
}