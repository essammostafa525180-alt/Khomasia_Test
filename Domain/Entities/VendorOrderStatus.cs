...
{
    public class VendorOrderStatus : AuditableEntityBase<int>
    {
        ...
        private VendorOrderStatus()
        {
        }

        public VendorOrderStatus(string? name, string? nameAr, bool isActive) : this()
        {
            Name = name;
            NameAr = nameAr;
            IsActive = isActive;
        ...
        public static VendorOrderStatus Create(string? name, string? nameAr, bool isActive)
        {

            return new VendorOrderStatus(name, nameAr, isActive);
        }
