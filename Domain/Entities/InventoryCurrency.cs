...
namespace Domain.Entities
{
    public class InventoryCurrency : AuditableEntityBase<int>
    {
        ...
        public InventoryCurrency(string? name, string? nameAr, bool isActive) : this()
        {
            Name = name;
            NameAr = nameAr;
            IsActive = isActive;
        ...
        public static InventoryCurrency Create(string? name, string? nameAr, bool isActive)
        {

            return new InventoryCurrency(name, nameAr, isActive);
        }
