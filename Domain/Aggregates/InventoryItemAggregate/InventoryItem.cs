...
using ItemType = Domain.Entities.ItemType;
...
namespace Domain.Aggregates.InventoryItemAggregate
{
    public class InventoryItem : AggregateRootEntityBase<long>
    {
        ...
        public string? ItemDescriptionAr { get; set; }          // VARCHAR(200)
        public string? ItemDescriptionEn { get; set; }          // VARCHAR(200)
        public int? ItemGroupId { get; set; }                  // FK -> ItemGroup
        public MaterialGroup? ItemGroup { get; set; }            //materialgroup
        public int? MaterialCategoryId { get; set; }                    // FK -> ItemCategory
        public MaterialCategory Category { get; set; }              //category
        public int? ItemTypeId { get; set; }                     // VARCHAR(20), CHECK IN ('STOCK','NON_STOCK','SERVICE','KIT')
        public ItemType? ItemType { get; set; }
        public int? BaseUOMID { get; set; }
        public InventoryItemUoM? BaseInventoryItemUoM { get; set; }
        ...
        public bool Inspectionrequired { get; set; } // BIT, NOT NULL الفحص مطلوب ولا لاه 
        /// <summary>
        /// اخر سعر شراء للعنصر
        /// </summary> 
        public decimal LastPurchaseCost { get; set; }                      // DECIMAL(19,6) 
    ...
    public InventoryItem()
        ...
        public InventoryItem(string? itemNumber, string? name, string? nameAr, long? itemTypeFK, long? chemicalGroupFK, 
            long? assetGroupFK, long? materialGroupFK, long? sparePartGroupFK, decimal? totalQuantity, long? unitOfMeasureFK,
            long? itemExpiryTypeFK, long? warrantyStatusFK, string? rFID, string? englishDescription, string? arabicDescription,
            bool? autoReplenishment, bool? isMaintainable, long? manufactureFK, decimal? minLevel, decimal? maxLevel,
            decimal? autoRequestQuantity, string? model, decimal? deliveryPeriodDays, decimal? concentration, 
            bool? isBatch, bool? isSerial, decimal? avgCost, bool? aXSynced, decimal? idelPeriod, decimal? lastPurchasePrice,
            bool? isScrap, long? itemQuantityTypeFK, long? materialCategoryFK, long? materialSubCategoryFK, bool isDisabled,
            decimal? density, decimal? volumeSolid, decimal? spreadingRate, decimal? dFT, decimal? packing, string? itemCode, bool isActive) : this()
        {
