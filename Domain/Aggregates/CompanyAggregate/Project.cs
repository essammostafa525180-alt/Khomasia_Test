...
namespace Domain.Aggregates.CompanyAggregate;
    ...
    public class Project : AggregateRootEntityBase<int>
    {
        ...
        public Project(string? code, string? name, string? nameAr, int? companyId, int? storeId, int? userId, bool isActive) : this()
        {
            Code = code;
            Name = name;
            NameAr = nameAr;
        ...
        public static Project Create(string? code, string? name, string? nameAr, int? companyFk, int? storeId, int? userId, bool isActive)
        {

            return new Project(code, name, nameAr, companyFk, storeId, userId, isActive);
        }

        public void Update(string? code, string? name, string? nameAr, int? companyId, int? storeId, int? userId, bool isActive)
        {
            Code = code;
            Name = name;
            NameAr = nameAr;
