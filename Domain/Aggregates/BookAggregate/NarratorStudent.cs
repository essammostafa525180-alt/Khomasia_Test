...
{    /// <summary>
     /// جدول تلاميذ الراوي
     /// </summary>
    public class NarratorStudent : AggregateRootEntityBase<int>
    {
        ...
        public NarratorStudent()
        {
        }
        public NarratorStudent(string name, int narratorId, string kunya,
        ...
        public static NarratorStudent Create(string name, int narratorId, string kunya,
            string honorific, string lineage,
            bool isActive)
        {
            Validator.NotNullOrWhiteSpace(name);

            return new NarratorStudent(name, narratorId, kunya, honorific, lineage, isActive);
        }
